	...
	<div id="notice-component">
		...
		<form>
			...
			><v-text-field
				value="noticeName"
				required
				v-model="eventsArray[0].name"
				class="noticeText"
				placeholder="Enter event name"
			/>
			<label class="noticeLabel">Event Organizer:</label
			><v-text-field
				value="noticeName"
				required
				v-model="organizer"
				...
				placeholder="Enter event name"
			/>
			<label class="noticeLabel" for="file">Upload header image: </label
			><input
				type="file"
				name="urlInput"
				ref="file"
				v-on:change="handleFileUpload()"
				class="noticeText inputfile"
			/>
			...
			<label class="noticeLabel">Venue:</label
			><v-text-field value="noticeName" required v-model="venue" class="noticeText" placeholder="Enter venue" />
			<label class="noticeLabel">Link:</label
			><v-text-field
				value="noticeName"
				required
				v-model="link"
				class="noticeText"
				placeholder="Enter the link for further reference"
			/>
			<v-btn v-on:click.prevent="postFileAndGetURL" id="noticeButton" class="blue lighten-2 mt-5" dark large
				>Submit</v-btn
			>
